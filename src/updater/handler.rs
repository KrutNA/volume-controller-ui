...
impl PulseHandler {
	...
	let mut proplist = Proplist::new()
	    .expect("Unable to create proplist");
	proplist.set_str(properties::APPLICATION_NAME, "VolumeController").unwrap();
	...
	let context = Rc::new(RefCell::new(
	    Context::new_with_proplist(mainloop.borrow().deref(),
    ...
    pub fn wait_for_operation<T: ?Sized> (
	&mut self,
